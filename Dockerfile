...
RUN python3 -m pip install docxbuilder elasticsearch-dsl elasticsearch pandas matplotlib isort plotly cufflinks notebook-as-pdf jupyter-cjk-xelatex yapf pyppeteer pillow autopep8 jupyter-docx-bundler jupyterlab_templates nb-mermaid
